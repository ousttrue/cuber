...
ToMat(const BvhMat3& rot, const BvhOffset& pos, float scaling)
{
  ...
  for (auto& joint : bvh->joints) {
    ...
    DirectX::XMStoreFloat4(
      ...
      DirectX::XMQuaternionRotationMatrix(
        DirectX::XMLoadFloat4x4((const DirectX::XMFLOAT4X4*)&rot)));
